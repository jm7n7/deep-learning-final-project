...
Ensure the datasets are uploaded to the specified Google Drive paths.

Mount Google Drive in the Colab notebooks.

Run the notebooks in the following order (independent pipelines):
